...
public class AttributeTreeNode extends NonLeafTreeNode {
    ...
    public AttributeTreeNode(DomainObjectType_attributesList_attribute attribute, NonLeafTreeNode parent) {
        super(TreeUtil.ATTRIBUTE_NODE_TYPE, attribute.getLongName(), parent, attribute);
