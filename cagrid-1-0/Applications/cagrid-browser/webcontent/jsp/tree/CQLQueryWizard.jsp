...
<br>
<h:form id="foo">
<h:panelGrid  width="85%" border="1" cellpadding="3" headerClass="formHeader" columnClasses="formLabel" cellspacing="0">
    ...
    <h:column>
        <h:panelGrid id="queryWizardPanel" columns="3" width="100%">
            <h:column>
                <t:tree2 id="clientTree" value="#{queryWizard.cqlTree}" var="node" varNodeToggler="t" clientSideToggle="true" preserveToggle="false">
...
<div align="center">
    <h:panelGrid>
        <h:column>
            <h:commandButton value="Create Query" action="#{queryWizard.createQuery}"></h:commandButton>
        </h:column>
    </h:panelGrid>
</div>
