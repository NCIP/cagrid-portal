...
import gov.nih.nci.cagrid.portal2.util.URLConstructor;
...
public class YahooGeocoder implements Geocoder {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see gov.nih.nci.cagrid.portal2.aggr.geocode.Geocoder#getGeocode(gov.nih.nci.cagrid.portal2.domain.Address)
	 */
