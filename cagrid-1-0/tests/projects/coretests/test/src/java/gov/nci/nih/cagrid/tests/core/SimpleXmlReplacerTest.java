	...
	extends TestCase
{
	...
	private void performTest(String testName) throws Exception
	{
		File inFile = new File("test", 
			"resources" + File.separator + "SimpleXmlReplacerTest" + File.separator + testName + ".xml"
		);
		File propFile = new File("test", 
			"resources" + File.separator + "SimpleXmlReplacerTest" + File.separator + testName + ".properties"
		);
		File compareFile = new File("test", 
			"resources" + File.separator + "SimpleXmlReplacerTest" + File.separator + testName + "_replaced.xml"
		);
		...
		try {
			...
			if (DEBUG) System.out.println(outFile);
			else outFile.delete();
		}
	}
