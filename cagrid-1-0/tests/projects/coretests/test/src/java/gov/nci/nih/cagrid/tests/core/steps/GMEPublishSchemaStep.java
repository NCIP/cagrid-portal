...
/**
 * This step publishes a schema and any of its imports to a running GME grid
 * service.
 * 
 * @author Patrick McConnell
 */
public class GMEPublishSchemaStep extends Step {
    ...
    public void runStep() throws Throwable {
        ...
        publishSchema(handle, this.schemaFile);
    }


    private void publishSchema(XMLDataModelService handle, File schemaFile) throws IOException,
        ParserConfigurationException, SAXException, NotSubNamespaceException, NotifyAuthorityException, MobiusException {
        publishSchema(handle, schemaFile, 0);
    }


    private void publishSchema(XMLDataModelService handle, File schemaFile, int level) throws IOException,
        ParserConfigurationException, SAXException, NotSubNamespaceException, NotifyAuthorityException, MobiusException {
