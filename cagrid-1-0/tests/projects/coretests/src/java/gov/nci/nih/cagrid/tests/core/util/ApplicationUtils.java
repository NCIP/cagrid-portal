...
public class ApplicationUtils
{
	...
	public static void writeApplication(Application application, File file) 
		throws Exception
	{
	...
	public static void main(String[] args) 
		throws Exception
	{
		//args = new String[] { "test" + File.separator + "resources" + File.separator + "userApplications" + File.separator + "user.xml" };
