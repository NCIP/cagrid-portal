...
/**
  ...
  * @version $Id: Sdk4ArgoUMLXMIHandler.java,v 1.1 2008-04-04 15:57:41 dervin Exp $
 */
class Sdk4ArgoUMLXMIHandler extends DefaultHandler {
    private static final Logger LOG = Logger.getLogger(Sdk4ArgoUMLXMIHandler.class);   
