...
import org.cagrid.gme.persistence.torque.TorqueSchemaPersistenceImpl;
...
//        try {
//
//            TorqueSchemaPersistenceImpl schemaPersistenceImpl = new TorqueSchemaPersistenceImpl();
//
//            File propsFile = new File("etc/torque.properties");
//            PropertiesConfiguration configuration = new PropertiesConfiguration(propsFile);
//            ((ConfigurationInitilizable) schemaPersistenceImpl).setConfiguration(configuration);
