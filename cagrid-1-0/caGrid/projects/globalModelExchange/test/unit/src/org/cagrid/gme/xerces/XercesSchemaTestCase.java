...
public class XercesSchemaTestCase extends TestCase {
    ...
    private static final XSModel loadSchemas(final Schema[] schemas, SchemaPersistenceI schemaPersistence)
        ...
        LSInputList list = new LSInputList() {
            public LSInput item(int index) {
                ...
                input.setSystemId(schemas[index].getSchemaDocument(0).getSystemID());
                input.setStringData(schemas[index].getSchemaDocument(0).getSchemaText());
                return input;
            }
