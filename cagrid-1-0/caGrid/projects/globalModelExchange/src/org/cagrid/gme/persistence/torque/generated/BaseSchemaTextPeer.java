 ...
 *
 */
public abstract class BaseSchemaTextPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(SchemaTextMapBuilder.CLASS_NAME);
    }

      /** the column name for the id field */
    public static final String ID;
      /** the column name for the schema_text field */
    ...
    static
    {
        ...
        TABLE_NAME = "schema_text";
              ...
              ID = "schema_text.id";
                  SCHEMA_TEXT = "schema_text.schema_text";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(SchemaTextMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(SchemaTextMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "org.cagrid.gme.persistence.torque.generated.SchemaText";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SchemaText> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(SCHEMA_TEXT);
      }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static SchemaText row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            SchemaText obj = (SchemaText) cls.newInstance();
            SchemaTextPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  obj.setSchemaText(row.getValue(offset + 1).asString());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SchemaText> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SchemaText> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SchemaText> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<SchemaText> results = new ArrayList<SchemaText>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(SchemaTextPeer.row2Object(row, 1,
                SchemaTextPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SchemaText> doSelect(SchemaText obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SchemaText obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SchemaText obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SchemaText obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(SchemaText) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SchemaText obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(SchemaText) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SchemaText obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(SchemaText) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SchemaText obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( SchemaText obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
            criteria.add(ID, obj.getId());
              criteria.add(SCHEMA_TEXT, obj.getSchemaText());
          return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( SchemaText obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static SchemaText retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SchemaText retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SchemaText retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        SchemaText retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SchemaText retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<SchemaText> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SchemaText> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<SchemaText> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SchemaText> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<SchemaText> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<SchemaText>();
        }
        else
        {
            Criteria criteria = new Criteria();
