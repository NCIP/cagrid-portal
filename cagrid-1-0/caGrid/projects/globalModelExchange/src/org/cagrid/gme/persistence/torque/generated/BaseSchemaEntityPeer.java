 ...
 *
 */
public abstract class BaseSchemaEntityPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(SchemaEntityMapBuilder.CLASS_NAME);
    }

      /** the column name for the id field */
    public static final String ID;
      /** the column name for the namespace_uri field */
    public static final String NAMESPACE_URI;
      /** the column name for the schema_text_id field */
    public static final String SCHEMA_TEXT_ID;
  
    static
    {
        DATABASE_NAME = "schemaStore";
        TABLE_NAME = "schema_entity";

              ID = "schema_entity.id";
                  NAMESPACE_URI = "schema_entity.namespace_uri";
                  SCHEMA_TEXT_ID = "schema_entity.schema_text_id";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(SchemaEntityMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(SchemaEntityMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "org.cagrid.gme.persistence.torque.generated.SchemaEntity";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SchemaEntity> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(NAMESPACE_URI);
          criteria.addSelectColumn(SCHEMA_TEXT_ID);
      }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static SchemaEntity row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            SchemaEntity obj = (SchemaEntity) cls.newInstance();
            SchemaEntityPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  obj.setNamespaceUri(row.getValue(offset + 1).asString());
                  obj.setSchemaTextId(row.getValue(offset + 2).asInt());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SchemaEntity> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SchemaEntity> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SchemaEntity> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<SchemaEntity> results = new ArrayList<SchemaEntity>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(SchemaEntityPeer.row2Object(row, 1,
                SchemaEntityPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SchemaEntity> doSelect(SchemaEntity obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SchemaEntity obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SchemaEntity obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SchemaEntity obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(SchemaEntity) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SchemaEntity obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(SchemaEntity) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SchemaEntity obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(SchemaEntity) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SchemaEntity obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( SchemaEntity obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
            criteria.add(ID, obj.getId());
              criteria.add(NAMESPACE_URI, obj.getNamespaceUri());
              criteria.add(SCHEMA_TEXT_ID, obj.getSchemaTextId());
          return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( SchemaEntity obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static SchemaEntity retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SchemaEntity retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SchemaEntity retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        SchemaEntity retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SchemaEntity retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<SchemaEntity> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SchemaEntity> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<SchemaEntity> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SchemaEntity> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<SchemaEntity> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<SchemaEntity>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of SchemaEntity objects pre-filled with their
     * SchemaText objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SchemaEntityPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SchemaEntity> doSelectJoinSchemaText(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinSchemaText(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SchemaEntity> doSelectJoinSchemaText(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        SchemaTextPeer.addSelectColumns(criteria);

                        criteria.addJoin(SchemaEntityPeer.SCHEMA_TEXT_ID,
            SchemaTextPeer.ID);
        ...
        List<SchemaEntity> results = new ArrayList<SchemaEntity>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

                            Class omClass = SchemaEntityPeer.getOMClass();
                    SchemaEntity obj1 = SchemaEntityPeer
                .row2Object(row, 1, omClass);
                     omClass = SchemaTextPeer.getOMClass();
                    SchemaText obj2 = SchemaTextPeer
                .row2Object(row, offset, omClass);

            boolean newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                SchemaEntity temp_obj1 =  results.get(j);
                SchemaText temp_obj2 = temp_obj1.getSchemaText();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                              temp_obj2.addSchemaEntity(obj1);
                              break;
                }
            }
                      if (newObject)
            {
                obj2.initSchemaEntitys();
                obj2.addSchemaEntity(obj1);
            }
                      results.add(obj1);
        }
        return results;
