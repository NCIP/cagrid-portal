 ...
 *          Exp $
 */
public class GridHostSubjectSource implements Source {

	private String id;
	private Set subjectTypes;


	public GridHostSubjectSource(String id) {
		this.id = id;
		this.subjectTypes = new HashSet();
		this.subjectTypes.add(SubjectTypeEnum.PERSON);
	}
	...
	public Subject getSubject(String arg0) throws SubjectNotFoundException, SubjectNotUniqueException {
		// TODO: Add Validation
		return new GridHostSubject(arg0, this);
	}
