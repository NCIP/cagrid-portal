 ...
 * The width and height of the tool tip can be customized using thid class.
 * The font can also be changed using this class
 * @author Vinay Kumar
 *
 */

public class InsatllerToolTip extends JToolTip
{
...
class MultiLineToolTipUI extends BasicToolTipUI {
	...
	public Dimension getPreferredSize(JComponent c) {
		...
		int width = ((InsatllerToolTip)c).getFixedWidth();
		int columns = ((InsatllerToolTip)c).getColumns();
