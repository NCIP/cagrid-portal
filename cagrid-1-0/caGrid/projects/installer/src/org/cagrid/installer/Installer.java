...
public class Installer {
    ...
    private void initSteps(Map<String, String> defaultState) {
        ...
        // these next twho steps are mutually exclusive.  ony one of the other will run
        // if someone selects a service which can only run in the tomcat container than
        // this will enable them to make sure the drop down for container selection is 
        // set to only the options that will work, in this case, only tomcat.
        // as support for more container becomes available this should be refacted to be
        // easier managed.
