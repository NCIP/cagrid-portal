...
public class Utils {
	...
	public static BeanUtils getBeanUtils() throws Exception {
		ClassPathResource properties = new ClassPathResource(
				Constants.DORIAN_PROPERTIES);
	...
	public static BeanUtils getBeanUtils(AbstractResource properties)
		...
		ClassPathResource cpr = new ClassPathResource(
				Constants.DORIAN_CONFIGURATION);
	...
	public static DorianProperties getExpiringDorianProperties()
			throws Exception {
		return getBeanUtils(
				new ClassPathResource(
						Constants.DORIAN_PROPERTIES_EXPIRING_CREDENTIALS))
				.getDorianProperties();
	}

	public static IdentityFederationProperties getIdentityFederationProperties()
			throws Exception {
	...
	public static IdentityProviderProperties getIdentityProviderProperties()
			throws Exception {
		return getBeanUtils().getIdentityProviderProperties();
	}

	public static AssertionCredentialsManager getAssertionCredentialsManager()
			throws Exception {
		return getBeanUtils().getAssertionCredentialsManager();
	}

	public static gov.nih.nci.cagrid.dorian.service.idp.UserManager getIdPUserManager()
			throws Exception {
	...
	public static String getDorianIdPUserId(String policy, String idpName,
	...
	public static String getDorianIdPUserId(String policy, String caSubject,
	...
	public static String getCASubject(CertificateAuthorityProperties conf)
			throws Exception {
		if (CA_SUBJECT == null) {
	...
	public static CertificateAuthorityProperties getCAProperties()
			throws Exception {
