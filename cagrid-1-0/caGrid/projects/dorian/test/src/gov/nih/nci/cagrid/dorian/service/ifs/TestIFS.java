...
public class TestIFS extends TestCase {
	...
	public void testFindHostCertificates() {
		...
		try {
			...
			String adminGridId = UserManager.subjectToIdentity(adminSubject);
			IFSUser usr = createUser(ifs, adminGridId, idp, "user");
			String subjectPrefix = gov.nih.nci.cagrid.dorian.common.Utils
	...
	private void validateCRLOnDisabledUserStatus(IFS ifs,
	...
	private void validateCRLOnDisabledHostStatus(IFS ifs,
	...
	private IFSUser createUser(IFS ifs, String adminGridId, IdPContainer idp,
