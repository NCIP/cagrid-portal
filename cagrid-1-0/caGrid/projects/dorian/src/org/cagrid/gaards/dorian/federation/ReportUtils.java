...
public class ReportUtils {
	...
	public static String generateReport(TrustedIdP original, TrustedIdP updated) {
		...
		if ((updated.getStatus() != null)
			...
			sb.append(count + ". Status changed from "
					+ original.getStatus().getValue() + " to "
		...
		if ((Utils.clean(updated.getAuthenticationServiceURL()) != null)
				&& (!updated.getAuthenticationServiceURL().equals(
		...
		if ((Utils.clean(updated.getAuthenticationServiceIdentity()) != null)
				&& (!updated.getAuthenticationServiceIdentity().equals(
		...
		if (!Arrays.equals(original.getAuthenticationMethod(), updated
	...
	public static String generateReport(GridUser original, GridUser updated) {
		...
		if ((updated.getUserStatus() != null)
			...
			count = count + 1;
			sb.append(count + ". Status changed from "
					+ original.getUserStatus().getValue() + " to "
