...
public class IdentityFederationManager extends LoggingObject implements Publisher {
	...
	public IdentityFederationManager(IdentityFederationProperties conf, Database db,
			PropertyManager properties, CertificateAuthority ca,
			FederationDefaults defaults) throws DorianInternalFault {
		this(conf, db, properties, ca, defaults, false);
	}

	public IdentityFederationManager(IdentityFederationProperties conf, Database db,
			PropertyManager properties, CertificateAuthority ca,
			FederationDefaults defaults, boolean ignoreCRL) throws DorianInternalFault {
		this.conf = conf;
		this.ca = ca;
