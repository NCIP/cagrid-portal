...
/**
 * DO NOT EDIT: This class is autogenerated! This is a PDP for use with the
 * globus authorization callout. This class will have a authorize<methodName>
 * method for each method on this grid service. The method is responsibe for
 * making any authorization callouts required to satisfy the authorization
 * requirements placed on each method call. Each method will either return apon
 * a successful authorization or will throw an exception apon a failed
 * authorization.
 * 
