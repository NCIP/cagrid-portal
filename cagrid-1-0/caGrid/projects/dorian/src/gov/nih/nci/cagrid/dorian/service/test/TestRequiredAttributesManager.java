 ...
 * @version $Id: TestRequiredAttributesManager.java,v 1.1 2005-09-27 18:31:18 langella Exp $
 */
public class TestRequiredAttributesManager extends TestCase{
    ...
    private void compareAttributes(AttributeDescriptor[] gold, int goldSize, AttributeDescriptor[] result){
	...
	protected void setUp() throws Exception {
		super.setUp();
		try{
		Document doc = XMLUtilities.fileNameToDocument(RESOURCES_DIR+File.separator+"db-config.xml");
