	...
	public static void main(String[] args) {
		...
		try {
			...
			if (line.getOptionValue(HELP_OPT) != null) {
				...
				DorianConfiguration c = (DorianConfiguration) rm.getResource(DorianConfiguration.RESOURCE);
				Database db = new Database(c.getConnectionManager(), c.getDorianInternalId());
				db.destroyDatabase();
