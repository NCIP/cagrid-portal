...
public class DorianClient extends ServiceSecurityClient implements DorianI {
	...
	public DorianClient(String url, GlobusCredential proxy)
			throws MalformedURIException, RemoteException {
		super(url, proxy);
		initialize();
	}

	public DorianClient(EndpointReferenceType epr)
			throws MalformedURIException, RemoteException {
		this(epr, null);
	}

	public DorianClient(EndpointReferenceType epr, GlobusCredential proxy)
			throws MalformedURIException, RemoteException {
		super(epr, proxy);
		initialize();
	}
	...
	public static void usage() {
		System.out
				.println(DorianClient.class.getName() + " -url <service url>");
	}
	...
	public java.lang.String registerWithIdP(
		...
		synchronized (portTypeMutex) {
			...
			gov.nih.nci.cagrid.dorian.stubs.RegisterWithIdPResponse boxedResult = portType
					.registerWithIdP(params);
	...
	public gov.nih.nci.cagrid.dorian.idp.bean.IdPUser[] findIdPUsers(
		...
		synchronized (portTypeMutex) {
			...
			gov.nih.nci.cagrid.dorian.stubs.FindIdPUsersResponse boxedResult = portType
					.findIdPUsers(params);
	...
	public void updateIdPUser(gov.nih.nci.cagrid.dorian.idp.bean.IdPUser user)
		...
		synchronized (portTypeMutex) {
			...
			gov.nih.nci.cagrid.dorian.stubs.UpdateIdPUserResponse boxedResult = portType
					.updateIdPUser(params);
		}
	}
	...
	public void removeIdPUser(java.lang.String userId) throws RemoteException,
		...
		synchronized (portTypeMutex) {
			...
			gov.nih.nci.cagrid.dorian.stubs.RemoveIdPUserResponse boxedResult = portType
					.removeIdPUser(params);
		}
	}
	...
	public gov.nih.nci.cagrid.dorian.bean.X509Certificate[] createProxy(
		...
		synchronized (portTypeMutex) {
			...
			gov.nih.nci.cagrid.dorian.stubs.CreateProxyResponse boxedResult = portType
					.createProxy(params);
	...
	public gov.nih.nci.cagrid.dorian.bean.X509Certificate getCACertificate()
		...
		synchronized (portTypeMutex) {
			...
			gov.nih.nci.cagrid.dorian.stubs.GetCACertificateResponse boxedResult = portType
					.getCACertificate(params);
			return boxedResult.getX509Certificate();
		}
	}
	...
	public gov.nih.nci.cagrid.dorian.ifs.bean.TrustedIdP[] getTrustedIdPs()
		...
		synchronized (portTypeMutex) {
			...
			gov.nih.nci.cagrid.dorian.stubs.GetTrustedIdPsResponse boxedResult = portType
					.getTrustedIdPs(params);
	...
	public gov.nih.nci.cagrid.dorian.ifs.bean.TrustedIdP addTrustedIdP(
		...
		synchronized (portTypeMutex) {
			...
			gov.nih.nci.cagrid.dorian.stubs.AddTrustedIdPResponse boxedResult = portType
					.addTrustedIdP(params);
			return boxedResult.getTrustedIdP();
		}
	}
	...
	public void updateTrustedIdP(
		...
		synchronized (portTypeMutex) {
			...
			gov.nih.nci.cagrid.dorian.stubs.UpdateTrustedIdPResponse boxedResult = portType
					.updateTrustedIdP(params);
		}
	}
	...
	public void removeTrustedIdP(
		...
		synchronized (portTypeMutex) {
			...
			trustedIdPContainer.setTrustedIdP(trustedIdP);
			params.setTrustedIdP(trustedIdPContainer);
			gov.nih.nci.cagrid.dorian.stubs.RemoveTrustedIdPResponse boxedResult = portType
					.removeTrustedIdP(params);
		}
	}
	...
	public gov.nih.nci.cagrid.dorian.ifs.bean.IFSUser[] findIFSUsers(
		...
		synchronized (portTypeMutex) {
			...
			params.setFilter(filterContainer);
			gov.nih.nci.cagrid.dorian.stubs.FindIFSUsersResponse boxedResult = portType
					.findIFSUsers(params);
	...
	public void updateIFSUser(gov.nih.nci.cagrid.dorian.ifs.bean.IFSUser user)
		...
		synchronized (portTypeMutex) {
			...
			params.setUser(userContainer);
			gov.nih.nci.cagrid.dorian.stubs.UpdateIFSUserResponse boxedResult = portType
					.updateIFSUser(params);
		}
	}
	...
	public void removeIFSUser(gov.nih.nci.cagrid.dorian.ifs.bean.IFSUser user)
		...
		synchronized (portTypeMutex) {
			...
			userContainer.setIFSUser(user);
			params.setUser(userContainer);
			gov.nih.nci.cagrid.dorian.stubs.RemoveIFSUserResponse boxedResult = portType
					.removeIFSUser(params);
		}
	}
	...
	public gov.nih.nci.cagrid.authentication.bean.SAMLAssertion authenticate(
		...
		synchronized (portTypeMutex) {
			...
			gov.nih.nci.cagrid.authentication.AuthenticateResponse boxedResult = portType
					.authenticate(params);
	...
	public void addAdmin(java.lang.String gridIdentity) throws RemoteException,
		...
		synchronized (portTypeMutex) {
			...
			gov.nih.nci.cagrid.dorian.stubs.AddAdminResponse boxedResult = portType
					.addAdmin(params);
		}
	}
	...
	public void removeAdmin(java.lang.String gridIdentity)
		...
		synchronized (portTypeMutex) {
			...
			params.setGridIdentity(gridIdentity);
			gov.nih.nci.cagrid.dorian.stubs.RemoveAdminResponse boxedResult = portType
					.removeAdmin(params);
		}
	}
	...
	public java.lang.String[] getAdmins() throws RemoteException,
		...
		synchronized (portTypeMutex) {
			...
			gov.nih.nci.cagrid.dorian.stubs.GetAdminsResponse boxedResult = portType
					.getAdmins(params);
			return boxedResult.getResponse();
		}
	}
	...
	public gov.nih.nci.cagrid.dorian.ifs.bean.HostCertificateRecord[] findHostCertificates(
		...
		synchronized (portTypeMutex) {
			...
			hostCertificateFilterContainer
					.setHostCertificateFilter(hostCertificateFilter);
	...
	public void updateHostCertificateRecord(
		...
		synchronized (portTypeMutex) {
			...
			hostCertificateUpdateContainer
					.setHostCertificateUpdate(hostCertificateUpdate);
