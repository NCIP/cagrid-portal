...
public class PortalLookAndFeel {
	 ...
	 public final static ImageIcon getInformIcon(){
	 	return new javax.swing.ImageIcon(PortalLookAndFeel.class.getResource("/Inform.gif"));
	 }
	 
	 public final static ImageIcon getAddIcon(){
	 	return new javax.swing.ImageIcon(PortalLookAndFeel.class.getResource("/Plus20X20.gif"));
	 }
	 
	 public final static ImageIcon getRemoveIcon(){
	 	return new javax.swing.ImageIcon(PortalLookAndFeel.class.getResource("/Minus.gif"));
	 }
