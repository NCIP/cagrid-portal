...
public class DorianImpl {
	...
	public DorianImpl() throws RemoteException {
		try {
			...
			String configFileEnd = (String) MessageContext.getCurrentContext()
					.getProperty(DORIAN_CONFIG);
			String configFile = ContainerConfig.getBaseDirectory()
					+ File.separator + configFileEnd;
