...
public class IFSAdministrationClient{
	...
	public IFSAdministrationClient(String serviceURI) throws MalformedURIException {
		client = new DorianClient(serviceURI);
	}


	public IFSAdministrationClient(String serviceURI, GlobusCredential proxy) throws MalformedURIException {
