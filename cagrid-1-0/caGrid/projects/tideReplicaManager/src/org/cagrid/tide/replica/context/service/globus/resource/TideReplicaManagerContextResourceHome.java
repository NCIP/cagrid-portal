...
public class TideReplicaManagerContextResourceHome extends ResourceHomeImpl {
    ...
    public ResourceKey createResource(String tideID) throws Exception {
        ...
        resource.initialize(props, TideReplicaManagerContextConstants.RESOURCE_PROPERTY_SET, id);
     ...
     */
    public TideReplicaManagerContextResource getResource(ResourceKey key) throws ResourceException {
     ...
     */
    public TideReplicaManagerContextResource getAddressedResource() throws Exception {
        TideReplicaManagerContextResource thisResource;
        thisResource = (TideReplicaManagerContextResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
