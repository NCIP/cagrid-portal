<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" exclude-result-prefixes="xlink" version="2.0">
	...
	<!-- nci hdr begins -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="hdrBG">
        <tr>
          ...
          <a href="http://www.cancer.gov"><img alt="National Cancer Institute" src="/example/images/logotype.gif" width="283" height="37" border="0"/></a>
          </td>          
          <td width="295" height="37" align="right">
          <a href="http://www.cancer.gov"><img alt="U.S. National Institutes of Health | www.cancer.gov" src="/example/images/tagline.gif" width="295" height="37" border="0"/></a>
          </td>
        </tr>
      </table>
  ...
  <!-- application hdr begins -->
  	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="subhdrBG">
  		...
  		<img src="/example/images/cabio58.gif" alt="Application Logo" height="35" hspace="10" border="0"/></a>
  		<img src="/example/images/cadsr.gif" alt="Application Logo" height="35" hspace="10" border="0"/>			
		<img src="/example/images/evs.gif" alt="Application Logo" height="35" hspace="10" border="0"/>
		<img src="/example/images/csm.gif" alt="Application Logo" height="35" hspace="10" border="0"/>
		</td>  		
...
<!-- footer begins -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ftrTable">
        <tr>
          <td valign="top">
            <div align="center">
              <a href="http://www.cancer.gov/"><img src="/example/images/footer_nci.gif" width="63" height="31" alt="National Cancer Institute" border="0"/></a>
              <a href="http://www.dhhs.gov/"><img src="/example/images/footer_hhs.gif" width="39" height="31" alt="Department of Health and Human Services" border="0"/></a>
              <a href="http://www.nih.gov/"><img src="/example/images/footer_nih.gif" width="46" height="31" alt="National Institutes of Health" border="0"/></a>
              <a href="http://www.firstgov.gov/"><img src="/example/images/footer_firstgov.gif" width="91" height="31" alt="FirstGov.gov" border="0"/></a>
            </div>
          </td>
        </tr>
      </table>
