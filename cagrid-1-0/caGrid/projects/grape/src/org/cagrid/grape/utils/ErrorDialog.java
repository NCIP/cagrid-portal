...
/**
 * PortalErrorDialog Dialog for displaying / queueing up errors and detail
 * messages
 * 
...
public class ErrorDialog extends JDialog {
	...
	protected static Frame setOwnerFrame() {
		return ownerFrame;
	}
	...
	private JScrollPane getErrorScrollPane() {
		if (errorScrollPane == null) {
			...
			errorScrollPane.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Errors",
	...
	private JScrollPane getDetailScrollPane() {
		if (detailScrollPane == null) {
			...
			detailScrollPane.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Detail",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION, null, PortalLookAndFeel.getPanelLabelColor()));
