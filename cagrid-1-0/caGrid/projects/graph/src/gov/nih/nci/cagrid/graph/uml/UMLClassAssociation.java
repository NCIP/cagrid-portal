...
public class UMLClassAssociation extends FigEdgePoly
{
     ...
     public void repositionLabelsAndArrowHeads()
     {
          ...
          // TODO: how do u know s_edge is the first element and d_edge is the last???
          ...
          else if(s_bot.getIntersection(s_edge) != null)
          {
               ...
               Point away = null;
               if(s_edge.p1.y >= s_bot.getIntersection(s_edge).y) away = s_edge.p1;
               else away = s_edge.p2;
          ...
          else if(d_bot.getIntersection(d_edge) != null)
          {
               ...
               Point away = null;
               if(d_edge.p1.y >= d_bot.getIntersection(d_edge).y) away = d_edge.p1;
               else away = d_edge.p2;
