...
public class DomainModelOverview extends JPanel {
	...
	public DomainModelOverview(DomainModel m, Vector packages) {
		...
		if (m != null) {
			...
			this.text.append("Total Classes: " + m.getExposedUMLClassCollection().length + "\n");
	...
	public void paint(Graphics g) {
		...
		// g.drawImage(nci.getImage(), 0, 0, nci.getIconWidth(),
		// nci.getIconHeight(), this);
		g.drawImage(nih.getImage(), this.getWidth() - this.nih.getIconWidth(), 0, nih.getIconWidth(), nih
			.getIconHeight(), this);
