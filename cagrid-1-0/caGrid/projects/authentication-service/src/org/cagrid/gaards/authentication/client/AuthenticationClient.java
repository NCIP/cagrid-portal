...
public class AuthenticationClient {
	...
	public static final QName AUTHENTICATION_PROFILES_METADATA = new QName(
	...
	public Set<QName> getSupportedAuthenticationProfiles()
		...
		try {
			InputStream wsdd = getClass().getResourceAsStream(
					"client-config.wsdd");
		...
		try {
			AuthenticationProfiles result = (AuthenticationProfiles) Utils
					.deserializeObject(new StringReader(XmlUtils
							.toString(resourceProperty)),
			...
			throw new ResourcePropertyRetrievalException(
					"Unable to deserailize: " + e.getMessage(), e);
		}
	}
}
