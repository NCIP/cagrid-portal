	...
	public static void main(String [] args){
		...
		if(!(args.length < 2)){
			if(args[0].equals("-url")){
			  ...
			  gov.nih.nci.cagrid.opensaml.SAMLAssertion saml2 = new gov.nih.nci.cagrid.opensaml.SAMLAssertion(new ByteArrayInputStream(saml.getXml().getBytes()));
			  GlobusCredential gridCred = 
			      ifsClient.createProxy(saml2, lifetime);
