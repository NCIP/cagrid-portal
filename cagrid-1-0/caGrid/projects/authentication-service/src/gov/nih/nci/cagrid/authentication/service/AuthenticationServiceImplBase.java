...
import gov.nih.nci.cagrid.authentication.service.globus.resource.AuthenticationServiceResource;
...
public abstract class AuthenticationServiceImplBase {
	...
	protected gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadataValue(){
		AuthenticationServiceResource serviceBaseResource;
		try {
			serviceBaseResource = (AuthenticationServiceResource)ResourceContext.getResourceContext().getResource();
	...
	protected Object getMetadata(QName metadataQName) {
		AuthenticationServiceResource serviceBaseResource = null;
		try {
			serviceBaseResource = (AuthenticationServiceResource) ResourceContext.getResourceContext().getResource();
		} catch (ResourceContextException e) {
			return null;
