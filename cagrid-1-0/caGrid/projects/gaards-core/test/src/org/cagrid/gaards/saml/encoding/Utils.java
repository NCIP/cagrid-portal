...
public class Utils {
	...
	public static String serialize(Object o) throws Exception {
		...
		gov.nih.nci.cagrid.common.Utils
				.serializeObject(o, new QName("A", "A"), writer,
						TestSAMLEncoding.class.getResourceAsStream(CLIENT_WSDD));
		return writer.toString();
	}

	public static Object deserialize(String s, Class c) throws Exception {
		return gov.nih.nci.cagrid.common.Utils.deserializeObject(new StringReader(s), c,
				TestSAMLEncoding.class
