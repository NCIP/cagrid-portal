...
public class GridTrustServiceImpl implements GridTrustServiceI {
	...
	public GridTrustServiceImpl() throws RemoteException {
		try {
			...
			BaseResourceHome home = (BaseResourceHome) ResourceContext
					.getResourceContext().getResourceHome();
			SimpleResourceManager srm = new SimpleResourceManager(home
					.getGtsConfig());
			GTSConfiguration conf = (GTSConfiguration) srm
	...
	public void removeTrustedAuthority(java.lang.String trustedAuthorityName)
			...
			gov.nih.nci.cagrid.gts.stubs.InvalidTrustedAuthorityFault,
	...
	public gov.nih.nci.cagrid.gts.bean.TrustedAuthority addTrustedAuthority(
			gov.nih.nci.cagrid.gts.bean.TrustedAuthority ta)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
	...
	public gov.nih.nci.cagrid.gts.bean.TrustedAuthority[] findTrustedAuthorities(
			gov.nih.nci.cagrid.gts.bean.TrustedAuthorityFilter f)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault {
		return gts.findTrustAuthorities(f);
	}

	public void addPermission(gov.nih.nci.cagrid.gts.bean.Permission permission)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
			gov.nih.nci.cagrid.gts.stubs.IllegalPermissionFault,
			gov.nih.nci.cagrid.gts.stubs.PermissionDeniedFault {
		gts.addPermission(permission, getCallerIdentity());
	}

	public gov.nih.nci.cagrid.gts.bean.Permission[] findPermissions(
			gov.nih.nci.cagrid.gts.bean.PermissionFilter f)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
			gov.nih.nci.cagrid.gts.stubs.PermissionDeniedFault {
	...
	public void revokePermission(
			gov.nih.nci.cagrid.gts.bean.Permission permission)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
			gov.nih.nci.cagrid.gts.stubs.InvalidPermissionFault,
			gov.nih.nci.cagrid.gts.stubs.PermissionDeniedFault {
		gts.revokePermission(permission, getCallerIdentity());
	}

	public void updateTrustedAuthority(
			gov.nih.nci.cagrid.gts.bean.TrustedAuthority ta)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
			gov.nih.nci.cagrid.gts.stubs.IllegalTrustedAuthorityFault,
	...
	public void addTrustLevel(gov.nih.nci.cagrid.gts.bean.TrustLevel trustLevel)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
			gov.nih.nci.cagrid.gts.stubs.IllegalTrustLevelFault,
			gov.nih.nci.cagrid.gts.stubs.PermissionDeniedFault {
		gts.addTrustLevel(trustLevel, getCallerIdentity());
	}

	public void updateTrustLevel(
			gov.nih.nci.cagrid.gts.bean.TrustLevel trustLevel)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
			gov.nih.nci.cagrid.gts.stubs.InvalidTrustLevelFault,
			gov.nih.nci.cagrid.gts.stubs.IllegalTrustLevelFault,
			gov.nih.nci.cagrid.gts.stubs.PermissionDeniedFault {
		gts.updateTrustLevel(trustLevel, getCallerIdentity());
	}

	public gov.nih.nci.cagrid.gts.bean.TrustLevel[] getTrustLevels()
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault {
		return gts.getTrustLevels();
	}

	public void removeTrustLevel(java.lang.String string)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
			gov.nih.nci.cagrid.gts.stubs.InvalidTrustLevelFault,
			gov.nih.nci.cagrid.gts.stubs.IllegalTrustLevelFault,
	...
	public void addAuthority(
			gov.nih.nci.cagrid.gts.bean.AuthorityGTS authorityGTS)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
			gov.nih.nci.cagrid.gts.stubs.IllegalAuthorityFault,
			gov.nih.nci.cagrid.gts.stubs.PermissionDeniedFault {
	...
	public void updateAuthority(
			...
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
			gov.nih.nci.cagrid.gts.stubs.IllegalAuthorityFault,
			gov.nih.nci.cagrid.gts.stubs.InvalidAuthorityFault,
			gov.nih.nci.cagrid.gts.stubs.PermissionDeniedFault {
		gts.updateAuthority(authorityGTS, getCallerIdentity());
	}

	public void updateAuthorityPriorities(
			gov.nih.nci.cagrid.gts.bean.AuthorityPriorityUpdate authorityPriorityUpdate)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
			gov.nih.nci.cagrid.gts.stubs.IllegalAuthorityFault,
			gov.nih.nci.cagrid.gts.stubs.PermissionDeniedFault {
		gts.updateAuthorityPriorities(authorityPriorityUpdate,
				getCallerIdentity());
	}

	public gov.nih.nci.cagrid.gts.bean.AuthorityGTS[] getAuthorities()
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault {
