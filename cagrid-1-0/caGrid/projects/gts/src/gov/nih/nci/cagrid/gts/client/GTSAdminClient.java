...
public class GTSAdminClient {
	...
	public Permission[] findPermissions(PermissionFilter f)
			throws RemoteException, GTSInternalFault, PermissionDeniedFault {
		return client.findPermissions(f);
	}

	public void addPermission(Permission permission) throws RemoteException,
			GTSInternalFault, IllegalPermissionFault, PermissionDeniedFault {
		client.addPermission(permission);
	}

	public void revokePermission(Permission permission) throws RemoteException,
			GTSInternalFault, InvalidPermissionFault, PermissionDeniedFault {
		client.revokePermission(permission);
	}

	public void addTrustLevel(TrustLevel trustLevel) throws RemoteException,
			GTSInternalFault, IllegalTrustLevelFault, PermissionDeniedFault {
		client.addTrustLevel(trustLevel);
	}

	public void updateTrustLevel(TrustLevel trustLevel) throws RemoteException,
			GTSInternalFault, InvalidTrustLevelFault, PermissionDeniedFault {
		client.updateTrustLevel(trustLevel);
	}

	public void removeTrustLevel(String trustLevelName) throws RemoteException,
			GTSInternalFault, InvalidTrustLevelFault, IllegalTrustLevelFault,
			PermissionDeniedFault {
		client.removeTrustLevel(trustLevelName);
	}

	public void updateAuthorityPriorities(AuthorityPriorityUpdate update)
			throws RemoteException, GTSInternalFault, IllegalAuthorityFault,
			PermissionDeniedFault {
		client.updateAuthorityPriorities(update);
	}

	public void removeAuthority(String serviceURI) throws RemoteException,
			GTSInternalFault, InvalidAuthorityFault, PermissionDeniedFault {
		client.removeAuthority(serviceURI);
	}

	public void addAuthority(AuthorityGTS gts) throws RemoteException,
			GTSInternalFault, IllegalAuthorityFault, PermissionDeniedFault {
		client.addAuthority(gts);
	}

	public void updateAuthority(AuthorityGTS gts) throws RemoteException,
			GTSInternalFault, IllegalAuthorityFault, InvalidAuthorityFault,
			PermissionDeniedFault {
