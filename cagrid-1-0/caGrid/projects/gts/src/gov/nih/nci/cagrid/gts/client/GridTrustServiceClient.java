...
public class GridTrustServiceClient implements GridTrustServiceI {
	...
	public static void usage() {
		System.out.println(GridTrustServiceClient.class.getName()
				+ " -gsh [gsh]");
	}
		...
		try {
			if (!(args.length < 2)) {
				if (args[0].equals("-gsh")) {
					GridTrustServiceClient client = new GridTrustServiceClient(
							args[1]);
	...
	public gov.nih.nci.cagrid.gts.bean.TrustedAuthority addTrustedAuthority(
		...
		gov.nih.nci.cagrid.gts.stubs.AddTrustedAuthorityResponse boxedResult = port
				.addTrustedAuthority(params);
	...
	public void removeTrustedAuthority(java.lang.String trustedAuthorityName)
		...
		gov.nih.nci.cagrid.gts.stubs.RemoveTrustedAuthorityResponse boxedResult = port
				.removeTrustedAuthority(params);
	...
	public void addPermission(gov.nih.nci.cagrid.gts.bean.Permission permission)
		...
		gov.nih.nci.cagrid.gts.stubs.AddPermissionResponse boxedResult = port
	...
	public gov.nih.nci.cagrid.gts.bean.Permission[] findPermissions(
		...
		params.setF(fContainer);
		gov.nih.nci.cagrid.gts.stubs.FindPermissionsResponse boxedResult = port
	...
	public void revokePermission(
		...
		permissionContainer.setPermission(permission);
		params.setPermission(permissionContainer);
		gov.nih.nci.cagrid.gts.stubs.RevokePermissionResponse boxedResult = port
	...
	public void updateTrustedAuthority(
		...
		taContainer.setTrustedAuthority(ta);
		params.setTa(taContainer);
		gov.nih.nci.cagrid.gts.stubs.UpdateTrustedAuthorityResponse boxedResult = port
				.updateTrustedAuthority(params);
	...
	public void addTrustLevel(gov.nih.nci.cagrid.gts.bean.TrustLevel trustLevel)
		...
		gov.nih.nci.cagrid.gts.stubs.AddTrustLevelResponse boxedResult = port
				.addTrustLevel(params);
	...
	public void updateTrustLevel(
		...
		trustLevelContainer.setTrustLevel(trustLevel);
		params.setTrustLevel(trustLevelContainer);
		gov.nih.nci.cagrid.gts.stubs.UpdateTrustLevelResponse boxedResult = port
				.updateTrustLevel(params);
	...
	public gov.nih.nci.cagrid.gts.bean.TrustLevel[] getTrustLevels()
		...
		gov.nih.nci.cagrid.gts.stubs.GetTrustLevelsResponse boxedResult = port
				.getTrustLevels(params);
	...
	public void removeTrustLevel(java.lang.String string)
		...
		gov.nih.nci.cagrid.gts.stubs.RemoveTrustLevelResponse boxedResult = port
				.removeTrustLevel(params);
	...
	public void addAuthority(
		...
		gov.nih.nci.cagrid.gts.stubs.AddAuthorityResponse boxedResult = port
				.addAuthority(params);
	...
	public void updateAuthority(
		...
		authorityGTSContainer.setAuthorityGTS(authorityGTS);
		params.setAuthorityGTS(authorityGTSContainer);
		gov.nih.nci.cagrid.gts.stubs.UpdateAuthorityResponse boxedResult = port
	...
	public void updateAuthorityPriorities(
		...
		authorityPriorityUpdateContainer
				.setAuthorityPriorityUpdate(authorityPriorityUpdate);
	...
	public gov.nih.nci.cagrid.gts.bean.AuthorityGTS[] getAuthorities()
		...
		gov.nih.nci.cagrid.gts.stubs.GetAuthoritiesResponse boxedResult = port
	...
	public void removeAuthority(java.lang.String serviceURI)
		...
		gov.nih.nci.cagrid.gts.stubs.RemoveAuthorityResponse boxedResult = port
