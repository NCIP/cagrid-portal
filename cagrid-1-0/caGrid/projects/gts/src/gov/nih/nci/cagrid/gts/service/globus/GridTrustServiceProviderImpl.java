...
public class GridTrustServiceProviderImpl {
	...
	public gov.nih.nci.cagrid.gts.stubs.AddTrustedAuthorityResponse addTrustedAuthority(
			gov.nih.nci.cagrid.gts.stubs.AddTrustedAuthority params)
		...
		boxedResult.setTrustedAuthority(impl.addTrustedAuthority(params.getTa()
				.getTrustedAuthority()));
		return boxedResult;
	}

	public gov.nih.nci.cagrid.gts.stubs.FindTrustedAuthoritiesResponse findTrustedAuthorities(
			gov.nih.nci.cagrid.gts.stubs.FindTrustedAuthorities params)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault {
		...
		boxedResult.setTrustedAuthority(impl.findTrustedAuthorities(params
				.getF().getTrustedAuthorityFilter()));
		return boxedResult;
	}

	public gov.nih.nci.cagrid.gts.stubs.RemoveTrustedAuthorityResponse removeTrustedAuthority(
			gov.nih.nci.cagrid.gts.stubs.RemoveTrustedAuthority params)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
	...
	public gov.nih.nci.cagrid.gts.stubs.AddPermissionResponse addPermission(
			gov.nih.nci.cagrid.gts.stubs.AddPermission params)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
	...
	public gov.nih.nci.cagrid.gts.stubs.FindPermissionsResponse findPermissions(
			gov.nih.nci.cagrid.gts.stubs.FindPermissions params)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
			gov.nih.nci.cagrid.gts.stubs.PermissionDeniedFault {
		...
		boxedResult.setPermission(impl.findPermissions(params.getF()
				.getPermissionFilter()));
		return boxedResult;
	}

	public gov.nih.nci.cagrid.gts.stubs.RevokePermissionResponse revokePermission(
			gov.nih.nci.cagrid.gts.stubs.RevokePermission params)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
	...
	public gov.nih.nci.cagrid.gts.stubs.UpdateTrustedAuthorityResponse updateTrustedAuthority(
			gov.nih.nci.cagrid.gts.stubs.UpdateTrustedAuthority params)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
			gov.nih.nci.cagrid.gts.stubs.IllegalTrustedAuthorityFault,
			gov.nih.nci.cagrid.gts.stubs.InvalidTrustedAuthorityFault,
	...
	public gov.nih.nci.cagrid.gts.stubs.AddTrustLevelResponse addTrustLevel(
			gov.nih.nci.cagrid.gts.stubs.AddTrustLevel params)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
	...
	public gov.nih.nci.cagrid.gts.stubs.UpdateTrustLevelResponse updateTrustLevel(
			gov.nih.nci.cagrid.gts.stubs.UpdateTrustLevel params)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
	...
	public gov.nih.nci.cagrid.gts.stubs.GetTrustLevelsResponse getTrustLevels(
			gov.nih.nci.cagrid.gts.stubs.GetTrustLevels params)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault {
	...
	public gov.nih.nci.cagrid.gts.stubs.RemoveTrustLevelResponse removeTrustLevel(
			gov.nih.nci.cagrid.gts.stubs.RemoveTrustLevel params)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
			gov.nih.nci.cagrid.gts.stubs.InvalidTrustLevelFault,
			gov.nih.nci.cagrid.gts.stubs.IllegalTrustLevelFault,
	...
	public gov.nih.nci.cagrid.gts.stubs.AddAuthorityResponse addAuthority(
			gov.nih.nci.cagrid.gts.stubs.AddAuthority params)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
	...
	public gov.nih.nci.cagrid.gts.stubs.UpdateAuthorityResponse updateAuthority(
			gov.nih.nci.cagrid.gts.stubs.UpdateAuthority params)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
			gov.nih.nci.cagrid.gts.stubs.IllegalAuthorityFault,
	...
	public gov.nih.nci.cagrid.gts.stubs.UpdateAuthorityPrioritiesResponse updateAuthorityPriorities(
			gov.nih.nci.cagrid.gts.stubs.UpdateAuthorityPriorities params)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
			gov.nih.nci.cagrid.gts.stubs.IllegalAuthorityFault,
			gov.nih.nci.cagrid.gts.stubs.PermissionDeniedFault {
		...
		impl.updateAuthorityPriorities(params.getAuthorityPriorityUpdate()
				.getAuthorityPriorityUpdate());
		return boxedResult;
	}

	public gov.nih.nci.cagrid.gts.stubs.GetAuthoritiesResponse getAuthorities(
			gov.nih.nci.cagrid.gts.stubs.GetAuthorities params)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault {
	...
	public gov.nih.nci.cagrid.gts.stubs.RemoveAuthorityResponse removeAuthority(
			gov.nih.nci.cagrid.gts.stubs.RemoveAuthority params)
			throws RemoteException,
			gov.nih.nci.cagrid.gts.stubs.GTSInternalFault,
			gov.nih.nci.cagrid.gts.stubs.InvalidAuthorityFault,
			gov.nih.nci.cagrid.gts.stubs.PermissionDeniedFault {
