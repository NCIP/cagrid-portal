...
public class MySQLTrustedAuthorityTable extends TrustedAuthorityTable {
	...
	public String getCreateTableSQL() {
		String sql = "CREATE TABLE " + TrustedAuthorityTable.TABLE_NAME + " ("
				...
				+ " VARCHAR(255) NOT NULL," + TrustedAuthorityTable.SOURCE_GTS
				+ " VARCHAR(255) NOT NULL," + TrustedAuthorityTable.EXPIRES
				+ " BIGINT NOT NULL," + TrustedAuthorityTable.LAST_UPDATED
				+ " BIGINT NOT NULL," + TrustedAuthorityTable.CERTIFICATE
				+ " TEXT NOT NULL," + TrustedAuthorityTable.CRL
				+ " TEXT, INDEX document_index (" + TrustedAuthorityTable.NAME
				+ "));";
		return sql;
	}
}
