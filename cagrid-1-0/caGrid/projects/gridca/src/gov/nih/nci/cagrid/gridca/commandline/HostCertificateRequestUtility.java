...
public class HostCertificateRequestUtility {
	...
	public static void main(String[] args) {
		try {
			...
			File dir = new File(Utils.getCaGridUserHome().getAbsolutePath()
					+ File.separator + "gridca");
			dir.mkdirs();

			File publicKey = new File(dir.getAbsolutePath() + File.separator
					+ hostname + "-public-key.pem");
			File privateKey = new File(dir.getAbsolutePath() + File.separator
					+ hostname + "-private-key.pem");
			File cert = new File(dir.getAbsolutePath() + File.separator
					+ hostname + "-cert.pem");
			File des = new File(dir.getAbsolutePath() + File.separator
					+ hostname + "-security-descriptor.xml");
			...
			File f = new File(dir.getAbsolutePath() + File.separator + hostname
					+ "-directions.txt");
			f.delete();
