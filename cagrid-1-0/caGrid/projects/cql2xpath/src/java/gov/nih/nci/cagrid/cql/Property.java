...
public class Property  implements java.io.Serializable {
    ...
    private gov.nih.nci.cagrid.cql.Predicate predicate;  // attribute
    ...
    public Property(
           ...
           gov.nih.nci.cagrid.cql.Predicate predicate,
     ...
     * @return predicate
     */
    public gov.nih.nci.cagrid.cql.Predicate getPredicate() {
        return predicate;
    }
     ...
     * @param predicate
     */
    public void setPredicate(gov.nih.nci.cagrid.cql.Predicate predicate) {
        this.predicate = predicate;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://CQL.caBIG/1/gov.nih.nci.cagrid.CQL", "Property"));
        ...
        attrField.setXmlType(new javax.xml.namespace.QName("http://CQL.caBIG/1/gov.nih.nci.cagrid.CQL", "Predicate"));
        typeDesc.addFieldDesc(attrField);
        attrField = new org.apache.axis.description.AttributeDesc();
