...
/** 
 *  DetachedCriteriaQueryGenerationTestCase
 *  Test case for generating Detached Criteria queries from CQL documents
 * 
 ...
 * @version $Id$ 
 */
public class DetachedCriteriaQueryGenerationTestCase extends TestCase {
	
	public DetachedCriteriaQueryGenerationTestCase(String name) {
		super(name);
	}
	...
	private void translateQuery(String filename) {
		...
		try {
			criteria = CQL2DetachedCriteria.translate(query);
	...
	public static void main(String[] args) {
		...
		TestResult result = runner.doRun(
			new TestSuite(DetachedCriteriaQueryGenerationTestCase.class));
