		...
		if (addButton == null) {
			...
			addButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					try {
						CaDSRServiceClient cadsr = new CaDSRServiceClient(cadsrUrl);
						UMLClassMetadata[] classes = cadsr.findClassesInPackage(getBrowserPanel().getSelectedProject(), pack.getName());
