 ...
 *          dervin Exp $
 */
public class MetadataUpgrade1pt1to1pt2 extends ExtensionUpgraderBase {

    private static final String CAGRID_1_1_METADATA_JAR_PREFIX = "caGrid-1.1-metadata";
    protected MetadataExtensionHelper helper;
    protected static Log LOG = LogFactory.getLog(MetadataUpgrade1pt1to1pt2.class.getName());
     ...
     * @param toVersion
     */
    public MetadataUpgrade1pt1to1pt2(ExtensionType extensionType, ServiceInformation serviceInfo, String servicePath,
