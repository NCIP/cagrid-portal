...
public interface MetadataConstants {
	...
	public static final String CADSR_DOMAIN_SCHEMA = CADSR_METADATA_SCHEMA_LOCATION + File.separator
		+ "3.0_gov.nih.nci.cadsr.domain.xsd";
	public static final String CADSR_UMLPROJECT_SCHEMA = CADSR_METADATA_SCHEMA_LOCATION + File.separator
		+ "3.0_gov.nih.nci.cadsr.umlproject.domain.xsd";
	...
	public static final String CADSR_URL_PROPERTY = "Cancer Data Standards Repositoty (CADSR) URL";
}
