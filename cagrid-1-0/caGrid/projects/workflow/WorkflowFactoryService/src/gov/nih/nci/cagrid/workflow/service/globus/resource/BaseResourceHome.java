...
public class BaseResourceHome extends SingletonResourceHome implements Initializable {
	...
	public Resource findSingleton() {
		...
		try {
			gov.nih.nci.cagrid.workflow.service.globus.resource.BaseResource resource = new gov.nih.nci.cagrid.workflow.service.globus.resource.BaseResource();
			resource.initialize();
			return resource;
		} catch (Exception e) {
	...
	public Resource find(ResourceKey key) throws ResourceException {
		gov.nih.nci.cagrid.workflow.service.globus.resource.BaseResource resource = (gov.nih.nci.cagrid.workflow.service.globus.resource.BaseResource) super
			.find(key);
