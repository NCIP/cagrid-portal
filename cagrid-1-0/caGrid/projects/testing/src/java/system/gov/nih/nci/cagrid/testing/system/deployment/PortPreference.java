...
public class PortPreference {
    ...
    public static PortPreference getDefaultPortPreference() {
        return new PortPreference(TestingConstants.TEST_PORT_LOWER_BOUND, TestingConstants.TEST_PORT_UPPER_BOUND, null);
    }
