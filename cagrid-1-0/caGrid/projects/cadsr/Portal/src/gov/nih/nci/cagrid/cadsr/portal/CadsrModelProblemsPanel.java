...
import gov.nih.nci.cagrid.cadsr.common.ModelProblem;
import gov.nih.nci.cagrid.cadsr.common.ModelProblemException;
import gov.nih.nci.cagrid.cadsr.common.ModelProblemsUtil;
 ...
 * @version $Id: CadsrModelProblemsPanel.java,v 1.1 2008-02-11 16:23:20 dervin Exp $ 
 */
public class CadsrModelProblemsPanel extends JPanel {
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    try {
                        ...
                        CompositeErrorDialog.showErrorDialog(
                            "Error reloading projects from caDSR application", ex.getMessage(), ex);
                    }
                }
            });
        }
        ...
        if (projectsComboBox == null) {
            ...
            projectsComboBox.setRenderer(new DefaultListCellRenderer() {
                public Component getListCellRendererComponent(
                    ...
                    return super.getListCellRendererComponent(list, renderValue,
    ...
    private JScrollPane getValidationResultsScrollPane() {
        if (validationResultsScrollPane == null) {
            ...
            validationResultsScrollPane.setBorder(BorderFactory.createTitledBorder(
                null, "Validation Results", TitledBorder.DEFAULT_JUSTIFICATION, 
                TitledBorder.DEFAULT_POSITION, null, LookAndFeel.getPanelLabelColor()));
            validationResultsScrollPane.setVerticalScrollBarPolicy(
    ...
    private ModelProblemsUtil getModelUtil() {
        if (modelUtil == null) {
            ApplicationService appservice = ApplicationService.getRemoteInstance(getCadsrApplicationUrl());
