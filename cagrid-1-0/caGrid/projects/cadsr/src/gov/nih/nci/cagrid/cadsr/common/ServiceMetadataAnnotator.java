...
public class ServiceMetadataAnnotator {
	...
	protected void annotateOperation(Operation operation) throws CaDSRGeneralException {
		...
		// TODO: set/edit operation semantic metadata once service's are
		// registered in caDSR
	...
	protected UML2XMLBinding getUML2XMLBinding() throws CaDSRGeneralException {
		try {
			Class clazz = Class.forName(this.uml2xmlImplClassname);
			return (UML2XMLBinding) clazz.newInstance();
		} catch (Exception e) {
			LOG.error("Unable to load UML2XMLBinding Class:" + this.uml2xmlImplClassname, e);
			throw new CaDSRGeneralException("Unable to load UML2XMLBinding Class:" + this.uml2xmlImplClassname, e);
		}
	}
