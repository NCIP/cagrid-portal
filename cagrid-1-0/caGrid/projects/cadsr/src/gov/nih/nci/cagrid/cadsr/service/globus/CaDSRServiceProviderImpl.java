...
public class CaDSRServiceProviderImpl {
	...
	public gov.nih.nci.cagrid.cadsr.stubs.FindPackagesInProjectResponse findPackagesInProject(
		gov.nih.nci.cagrid.cadsr.stubs.FindPackagesInProject params) throws RemoteException {
	...
	public gov.nih.nci.cagrid.cadsr.stubs.FindClassesInProjectResponse findClassesInProject(
		gov.nih.nci.cagrid.cadsr.stubs.FindClassesInProject params) throws RemoteException {
	...
	public gov.nih.nci.cagrid.cadsr.stubs.FindClassesInPackageResponse findClassesInPackage(
		gov.nih.nci.cagrid.cadsr.stubs.FindClassesInPackage params) throws RemoteException {
		...
		boxedResult.setUMLClassMetadata(impl.findClassesInPackage(params.getProject().getProject(), params
			.getPackageName()));
		return boxedResult;
	}


	public gov.nih.nci.cagrid.cadsr.stubs.GenerateMetadataExtractForProjectResponse generateMetadataExtractForProject(
		gov.nih.nci.cagrid.cadsr.stubs.GenerateMetadataExtractForProject params) throws RemoteException {
	...
	public gov.nih.nci.cagrid.cadsr.stubs.GenerateMetadataExtractForPackagesResponse generateMetadataExtractForPackages(
		gov.nih.nci.cagrid.cadsr.stubs.GenerateMetadataExtractForPackages params) throws RemoteException {
		...
		boxedResult.setResponse(impl.generateMetadataExtractForPackages(params.getProject().getProject(), params
			.getPackageNames()));
		return boxedResult;
	}


	public gov.nih.nci.cagrid.cadsr.stubs.GenerateMetadataExtractForClassesResponse generateMetadataExtractForClasses(
		gov.nih.nci.cagrid.cadsr.stubs.GenerateMetadataExtractForClasses params) throws RemoteException {
		...
		boxedResult.setResponse(impl.generateMetadataExtractForClasses(params.getProject().getProject(), params
			.getClasses().getUMLClassMetadata()));
		return boxedResult;
	}


	public gov.nih.nci.cagrid.cadsr.stubs.FindAttributesInClassResponse findAttributesInClass(
