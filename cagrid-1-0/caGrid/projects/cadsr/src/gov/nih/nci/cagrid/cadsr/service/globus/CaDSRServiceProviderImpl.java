...
public class CaDSRServiceProviderImpl{
	...
	public gov.nih.nci.cagrid.cadsr.stubs.FindPackagesInProjectResponse findPackagesInProject(gov.nih.nci.cagrid.cadsr.stubs.FindPackagesInProjectRequest params) throws RemoteException {
	...
	public gov.nih.nci.cagrid.cadsr.stubs.FindClassesInProjectResponse findClassesInProject(gov.nih.nci.cagrid.cadsr.stubs.FindClassesInProjectRequest params) throws RemoteException {
	...
	public gov.nih.nci.cagrid.cadsr.stubs.FindClassesInPackageResponse findClassesInPackage(gov.nih.nci.cagrid.cadsr.stubs.FindClassesInPackageRequest params) throws RemoteException {
	...
	public gov.nih.nci.cagrid.cadsr.stubs.GenerateDomainModelForProjectResponse generateDomainModelForProject(gov.nih.nci.cagrid.cadsr.stubs.GenerateDomainModelForProjectRequest params) throws RemoteException {
	...
	public gov.nih.nci.cagrid.cadsr.stubs.GenerateDomainModelForPackagesResponse generateDomainModelForPackages(gov.nih.nci.cagrid.cadsr.stubs.GenerateDomainModelForPackagesRequest params) throws RemoteException {
	...
	public gov.nih.nci.cagrid.cadsr.stubs.GenerateDomainModelForClassesResponse generateDomainModelForClasses(gov.nih.nci.cagrid.cadsr.stubs.GenerateDomainModelForClassesRequest params) throws RemoteException {
	...
	public gov.nih.nci.cagrid.cadsr.stubs.FindAttributesInClassResponse findAttributesInClass(gov.nih.nci.cagrid.cadsr.stubs.FindAttributesInClassRequest params) throws RemoteException {
	...
	public gov.nih.nci.cagrid.cadsr.stubs.FindSemanticMetadataForClassResponse findSemanticMetadataForClass(gov.nih.nci.cagrid.cadsr.stubs.FindSemanticMetadataForClassRequest params) throws RemoteException {
	...
	public gov.nih.nci.cagrid.cadsr.stubs.FindValueDomainForAttributeResponse findValueDomainForAttribute(gov.nih.nci.cagrid.cadsr.stubs.FindValueDomainForAttributeRequest params) throws RemoteException {
	...
	public gov.nih.nci.cagrid.cadsr.stubs.FindAssociationsForClassResponse findAssociationsForClass(gov.nih.nci.cagrid.cadsr.stubs.FindAssociationsForClassRequest params) throws RemoteException {
	...
	public gov.nih.nci.cagrid.cadsr.stubs.FindAssociationsInPackageResponse findAssociationsInPackage(gov.nih.nci.cagrid.cadsr.stubs.FindAssociationsInPackageRequest params) throws RemoteException {
	...
	public gov.nih.nci.cagrid.cadsr.stubs.FindAssociationsInProjectResponse findAssociationsInProject(gov.nih.nci.cagrid.cadsr.stubs.FindAssociationsInProjectRequest params) throws RemoteException {
