...
public class FederatedQueryResultsClient extends ServiceSecurityClient implements FederatedQueryResultsI {
    ...
    public org.oasis.wsrf.lifetime.DestroyResponse destroy(org.oasis.wsrf.lifetime.Destroy params)
        ...
        synchronized (this.portTypeMutex) {
            ...
            return this.portType.destroy(params);
        }
    }
    ...
    public org.oasis.wsrf.lifetime.SetTerminationTimeResponse setTerminationTime(
        ...
        synchronized (this.portTypeMutex) {
            ...
            return this.portType.setTerminationTime(params);
        }
    }
    ...
    public gov.nih.nci.cagrid.dcqlresult.DCQLQueryResultsCollection getResults() throws RemoteException,
        ...
        synchronized (this.portTypeMutex) {
            configureStubSecurity((Stub) this.portType, "getResults");
            gov.nih.nci.cagrid.fqp.results.stubs.GetResultsRequest params = new gov.nih.nci.cagrid.fqp.results.stubs.GetResultsRequest();
            gov.nih.nci.cagrid.fqp.results.stubs.GetResultsResponse boxedResult = this.portType.getResults(params);
    ...
    public boolean isProcessingComplete() throws RemoteException {
        synchronized (this.portTypeMutex) {
            configureStubSecurity((Stub) this.portType, "isProcessingComplete");
            ...
            gov.nih.nci.cagrid.fqp.results.stubs.IsProcessingCompleteResponse boxedResult = this.portType
                .isProcessingComplete(params);
