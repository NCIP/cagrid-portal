...
public class ServiceSecurityClient implements ServiceSecurityI {	
	...
	public ServiceSecurityClient(String url, GlobusCredential proxy) throws MalformedURIException {
	   	this.proxy = proxy;
	   	this.epr = new EndpointReferenceType();
	   	this.epr.setAddress(new Address(url));
	}
	
	public ServiceSecurityClient(EndpointReferenceType epr) throws MalformedURIException {
	   	this(epr,null);
	}
	...
	public static void main(String [] args){
		...
		if(!(args.length < 2)){
	     ...
	     public gov.nih.nci.cagrid.metadata.security.ServiceSecurityMetadata getServiceSecurityMetadata() throws RemoteException {
               ...
               gov.nih.nci.cagrid.introduce.security.stubs.GetServiceSecurityMetadataResponse boxedResult = port.getServiceSecurityMetadata(params);
