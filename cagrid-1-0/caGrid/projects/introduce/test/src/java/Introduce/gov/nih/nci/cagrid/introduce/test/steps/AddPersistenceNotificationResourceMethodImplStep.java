...
public class AddPersistenceNotificationResourceMethodImplStep extends BaseStep {
    ...
    public void runStep() throws Throwable {
        ...
        File inFileClient = new File(this.getClass().getResource("/gold/persistentnotification/" + tci.getName() + "SetClient.java").getFile());
        ...
        inFileClient = new File(this.getClass().getResource("/gold/persistentnotification/" + tci2.getName() + "Client.java").getFile());
        ...
        File inFileImpl = new File(this.getClass().getResource("/gold/persistentnotification/" + tci2.getName() + "Impl.java").getFile());
        ...
        inFileImpl = new File(this.getClass().getResource("/gold/persistentnotification/" + tci2.getName() + "Impl.java").getFile());
