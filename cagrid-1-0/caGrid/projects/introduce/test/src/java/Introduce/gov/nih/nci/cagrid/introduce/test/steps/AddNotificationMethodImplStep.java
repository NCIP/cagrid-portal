...
public class AddNotificationMethodImplStep extends BaseStep {
    ...
    public void runStep() throws Throwable {
        ...
        File inFileClient = new File("test" + File.separator + "resources" + File.separator + "gold" + File.separator
            + "notification" + File.separator + tci.getName() + "Client.java");
        ...
        File inFileImpl = new File("test" + File.separator + "resources" + File.separator + "gold" + File.separator + "notification" + File.separator + tci.getName() + "Impl.java");
