...
public class AddNotificationMethodImplStep extends BaseStep {
    ...
    public void runStep() throws Throwable {
        ...
        File inFileClient = new File(this.getClass().getResource("/gold/notification/" + tci.getName() + "Client.java").getFile());
        ...
        File inFileImpl = new File(this.getClass().getResource("/gold/notification/"+ tci.getName() + "Impl.java").getFile());
