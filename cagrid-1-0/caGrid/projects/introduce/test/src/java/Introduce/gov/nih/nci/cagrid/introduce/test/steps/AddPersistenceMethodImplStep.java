...
public class AddPersistenceMethodImplStep extends BaseStep {
    ...
    public void runStep() throws Throwable {
        ...
        File inFileClient = new File(this.getClass().getResource("/gold/persistence/" + tci.getName() + "ClientSet.java").getFile());
        ...
        File inFileImpl = new File(this.getClass().getResource("/gold/persistence/" + tci.getName() + "Impl.java").getFile());
        ...
        inFileImpl = new File(this.getClass().getResource("/gold/persistence/" + tci.getName() + "Impl.java").getFile());
