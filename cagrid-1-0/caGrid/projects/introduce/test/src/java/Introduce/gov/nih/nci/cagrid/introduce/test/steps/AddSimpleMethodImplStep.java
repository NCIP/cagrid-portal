...
public class AddSimpleMethodImplStep extends BaseStep {
	...
	public void runStep() throws Throwable {
		...
		File inFileClient = new File("test" + File.separator + "resources" + File.separator + "gold" + File.separator + "simple" + File.separator + "SimpleMethodClient.java");
		...
		File inFileImpl = new File("test" + File.separator + "resources" + File.separator + "gold" + File.separator  + "simple" + File.separator + "SimpleMethodImpl.java");
