 ...
 */
public class IntroduceSplash extends Frame {
	 ...
	 *            image.
	 */
	public IntroduceSplash(String aImageId) {
		/*
	...
	private void initImageAndTracker() {
		...
		URL imageURL = IntroduceSplash.class.getResource(fImageId);
	...
	private static void main(String[] args) {
		IntroduceSplash splashScreen = new IntroduceSplash(
				"images/StocksMonitor.gif");
		splashScreen.splash();
		try {
			Thread.sleep(2000);
