...
public class UndeployServiceViewer extends ApplicationComponent {
	...
	private JPanel getServicePanel() {
		if (servicePanel == null) {
			...
			servicePanel.setBorder(BorderFactory.createTitledBorder(null,
					"Deployed Services", TitledBorder.DEFAULT_JUSTIFICATION,
	...
	private JPanel getContainrePanel() {
		if (containrePanel == null) {
			...
			containrePanel.add(getContainerSelectorComboBox(),
					gridBagConstraints3);
		}
						...
						public void actionPerformed(java.awt.event.ActionEvent e) {
							try {
								...
								if (dep != null) {
									...
									if (containerType
											.equals(DeploymentViewer.GLOBUS)) {
										webAppDir = System
												.getenv("GLOBUS_LOCATION");
										webAppEtcDir = webAppDir
												+ File.separator + "etc";
										webAppLibDir = webAppDir
												+ File.separator + "lib";
										webAppSchemaDir = webAppDir
