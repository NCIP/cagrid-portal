 ...
 *          Exp $
 */
public abstract class PreferencesTypeTreeNode extends DefaultMutableTreeNode {

	private DefaultTreeModel model;
	private String name;

	public PreferencesTypeTreeNode(String displayName, DefaultTreeModel model) {
		super();
		this.model = model;
	...
	/*
	 * This method must be implemented and must return the configuration
