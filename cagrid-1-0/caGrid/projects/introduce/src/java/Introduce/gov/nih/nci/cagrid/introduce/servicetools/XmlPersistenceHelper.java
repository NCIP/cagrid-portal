...
public class XmlPersistenceHelper extends FilePersistenceHelper implements PersistenceHelper {
    ...
    /* (non-Javadoc)
     * @see gov.nih.nci.cagrid.introduce.servicetools.PersistanceHelper#load(java.lang.Object, gov.nih.nci.cagrid.introduce.servicetools.ReflectionResource)
     */
    ...
    public void remove(ReflectionResource resource)
        ...
        if (!this.beanClass.isAssignableFrom(resourceBean)) {
            Object[] args = 
                new Object[] {this.beanClass, resourceBean};
