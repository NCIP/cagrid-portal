 ...
 * version of extension. The extension upgrader should only touch parts of hte
 * service that the extension etself controls, i.e. the extension data in the
 * xml entity in the introduce.xml document in the services top level directory.
