...
public class Introduce_1_0__1_1_Upgrader extends IntroduceUpgraderBase {
    ...
    public Introduce_1_0__1_1_Upgrader(IntroduceUpgradeStatus status, ServiceInformation serviceInformation,
        String servicePath) {
        ...
        for (int i = 0; i < getServiceInformation().getServices().getService().length; i++) {
            ...
            if (!service.getResourceFrameworkType().equals(IntroduceConstants.INTRODUCE_CUSTOM_RESOURCE)) {
                ...
                if (service.getResourceFrameworkType().equals(IntroduceConstants.INTRODUCE_BASE_RESOURCE)) {
                    ...
                    String lifetimeResourceBaseS = lifetimeResourceBaseT.generate(new SpecificServiceInformation(
                        getServiceInformation(), service));
                    ...
                    String lifetimeResourceS = lifetimeResourceT.generate(new SpecificServiceInformation(
                        getServiceInformation(), service));
                    ...
                    String lifetimeResourceHomeS = lifetimeResourceHomeT.generate(new SpecificServiceInformation(
                        getServiceInformation(), service));
