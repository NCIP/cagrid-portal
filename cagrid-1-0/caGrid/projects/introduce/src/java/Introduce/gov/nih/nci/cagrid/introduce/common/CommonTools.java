...
public class CommonTools {
    ...
    public static void addSubscribeResource(ServiceType service, ServiceInformation info){
    ...
    public static void addLifetimeResource(ServiceType service, ServiceInformation info) {
