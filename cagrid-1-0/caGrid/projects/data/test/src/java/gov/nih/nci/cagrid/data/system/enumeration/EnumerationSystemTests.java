 ...
 * @created Nov 7, 2006 
 * @version $Id: EnumerationSystemTests.java,v 1.1 2006-12-18 14:48:47 dervin Exp $ 
 */
public class EnumerationSystemTests extends Story {
	public static final String INTRODUCE_DIR_PROPERTY = "introduce.base.dir";
	
	private static GlobusHelper globusHelper = 
		new GlobusHelper(false, 
			new File(IntroduceTestConstants.TEST_TEMP), IntroduceTestConstants.TEST_PORT + 2);
	...
	protected Vector steps() {
		...
		// an enumeration supporting data service is presumed to have been created
		// by a previous testing process
		// 1) Add the bookstore schema to the data service
		steps.add(new AddBookstoreStep(CreateEnumerationTests.SERVICE_DIR, CreateEnumerationTests.SERVICE_NAME));
		...
		steps.add(new RebuildServiceStep(getIntroduceBaseDir(), CreateEnumerationTests.SERVICE_DIR, 
			CreateEnumerationTests.SERVICE_NAME, CreateEnumerationTests.PACKAGE_NAME, CreateEnumerationTests.SERVICE_NAMESPACE));
		...
		// 8) test data service
		steps.add(new InvokeEnumerationDataServiceStep(
			"localhost", IntroduceTestConstants.TEST_PORT + 2, CreateEnumerationTests.SERVICE_NAME));
