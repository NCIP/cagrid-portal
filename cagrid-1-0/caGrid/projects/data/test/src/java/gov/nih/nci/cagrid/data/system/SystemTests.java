...
public class SystemTests extends Story {
	...
	protected Vector steps() {
		...
		steps.add(new RebuildServiceStep(getIntroduceBaseDir(), CreationTests.SERVICE_DIR, CreationTests.SERVICE_NAME,
		...
		// 8) test data service
		steps.add(new InvokeDataServiceStep("localhost", IntroduceTestConstants.TEST_PORT + 1,
