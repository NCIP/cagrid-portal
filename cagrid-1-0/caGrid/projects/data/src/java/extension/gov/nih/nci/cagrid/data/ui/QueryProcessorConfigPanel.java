...
public class QueryProcessorConfigPanel extends JPanel {
    ...
    private ClassBrowserPanel getClassBrowserPanel() {
        if (classBrowserPanel == null) {
            classBrowserPanel = new ClassBrowserPanel(dataManager, serviceInfo);
            ...
            classBrowserPanel.addAdditionalJarsChangeListener(new AdditionalJarsChangeListener() {
                public void additionalJarsChanged(AdditionalJarsChangedEvent e) {
                    ...
                    try {
                        dataManager.setAdditionalJars(additionalJars);
                    } catch (Exception ex) {
                        ex.printStackTrace();
    ...
    private QueryProcessorParametersTable getQpParamsTable() {
        if (qpParamsTable == null) {
            ...
            qpParamsTable = new QueryProcessorParametersTable(dataManager, serviceInfo);
    ...
    private void saveProcessorClassName(String className) throws Exception {
        ...
        ServicePropertiesProperty[] oldProperties = serviceInfo.getServiceProperties().getProperty();
        ...
        serviceInfo.getServiceDescriptor().getServiceProperties().setProperty(properties);
    ...
    private void launchQueryProcessorConfigUi() {
        String stubQpClassname = ExtensionDataUtils.getQueryProcessorStubClassName(serviceInfo);
            ...
            if (uiClass != null) {
                ...
                try {
                    ...
                    postUiConfig = QueryProcessorConfigurationDialog
                        .showConfigurationUi(uiPanel, serviceInfo.getBaseDirectory(), currentConfig);
                } catch (Exception ex) {
                    ex.printStackTrace();
