 ...
 * @version $Id: DetailsConfigurationPanel.java,v 1.1 2007-06-27 16:20:37 dervin Exp $ 
 */
public class DetailsConfigurationPanel extends JPanel implements UpdatablePanel {
            ...
            classConfigTable.addClassInformatonChangeListener(new ClassInformatonChangeListener() {
                public void elementNameChanged(ClassChangeEvent e) {
                    ...
                    NamespaceType nsType = CommonTools.getNamespaceType(
                        serviceInfo.getNamespaces(), e.getNamespace());
