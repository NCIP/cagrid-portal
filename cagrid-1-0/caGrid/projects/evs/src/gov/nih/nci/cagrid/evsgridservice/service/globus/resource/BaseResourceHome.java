...
public class BaseResourceHome extends SingletonResourceHome implements Initializable {
	...
	public Resource findSingleton() {
		...
		try {
			EVSGridServiceResource resource = new EVSGridServiceResource();
			resource.initialize();
			return resource;
		} catch (Exception e) {
	...
	public EVSGridServiceResource getResource(){
	...
	public Resource find(ResourceKey key) throws ResourceException {
		EVSGridServiceResource resource = (EVSGridServiceResource) super.find(key);
     ...
     */
    public EVSGridServiceResource getAddressedResource() throws Exception {
        EVSGridServiceResource thisResource;
        thisResource = (EVSGridServiceResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
}