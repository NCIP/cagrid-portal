...
public class MageTranslationServicesClient extends ServiceSecurityClient implements MageTranslationServicesI {	
	...
	public void mageToMage() throws RemoteException {
      synchronized(portTypeMutex){
        configureStubSecurity((Stub)portType,"mageToMage");
        gov.nih.nci.cagrid.annualdemo.stubs.MageToMageRequest params = new gov.nih.nci.cagrid.annualdemo.stubs.MageToMageRequest();
        gov.nih.nci.cagrid.annualdemo.stubs.MageToMageResponse boxedResult = portType.mageToMage(params);
      }
    }
