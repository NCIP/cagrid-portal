...
insert into User_ (userId, companyId, createDate, modifiedDate, defaultUser, contactId, password_, passwordEncrypted, passwordReset, screenName, emailAddress, greeting, loginDate, failedLoginAttempts, agreedToTermsOfUse, active_) values (2, 1, now(), now(), 0, 3, 'p0rtal@dmin', 0, 0, 'portaladmin', 'portaladmin@cabig.nci.nih.gov', 'Welcome Portal Admin!', now(), 0, 1, 1);
insert into Contact_ (contactId, companyId, userId, userName, createDate, modifiedDate, accountId, parentContactId, firstName, middleName, lastName, male, birthday) values (3, 1, 2, 'Portal Admin', now(), now(), 7, 0, 'Portal', '', 'Admin', 1, '1970-01-01');
...
insert into Release_ (releaseId, createDate, modifiedDate, buildNumber, verified) values (1, now(), now(), 4303, 0);
