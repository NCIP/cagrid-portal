...
/**
  ...
  * @version $Id: XMI12Parser.java,v 1.1 2008-05-28 03:05:44 joshua Exp $
 */
public class XMI12Parser {
    DomainModel model;
    ...
    public XMI12Parser(String projectShortName, String projectVersion) {
        super();
    ...
    public DomainModel parse(InputStream xmiStream) throws SAXException, IOException, ParserConfigurationException {
        ...
        XMI12Handler handler = new XMI12Handler(this);
