 ...
 * 
 */
public class Model1SvcConfiguration implements ServiceConfiguration {

	public static Model1SvcConfiguration  configuration = null;

	public static Model1SvcConfiguration getConfiguration() throws Exception {
		if (Model1SvcConfiguration.configuration != null) {
			return Model1SvcConfiguration.configuration;
		}
		...
		try {
			...
			Model1SvcConfiguration.configuration = (Model1SvcConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
